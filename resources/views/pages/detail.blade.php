...
<div class="page-content page-details">
    ...
    <div class="store-details-container" data-aos="fade-up">
        <section class="store-heading">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <h1>{{$item->name}}</h1>
                        <div class="owner">By {{$item->user->store_name}}</div>
        ...
        <section class="store-descripstion">
            <div class="container">
                <div class="row">
                        ...
                        <ul class="list-unstyled">
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">Rolanda Difandana</h5>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi itaque odit laboriosam earum pariatur nulla molestiae optio tenetur voluptate perspiciatis!
                                </div>
                            </li>
                            <li class="media">
                                ...
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">Rolanda Difandana</h5>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi itaque odit laboriosam earum pariatur nulla molestiae
                                    optio tenetur voluptate perspiciatis!
                                </div>
                            </li>
                            <li class="media">
