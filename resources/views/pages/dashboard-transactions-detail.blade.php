                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-4">
                                    <img src="{{ Storage::url($transactions->product->galleries->first()->photos) }}" class="w-100 mb-3" alt="">
                                </div>
                                <div class="col-12 col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="product-subtitle text-danger">{{ $transactions->shipping_status}}</div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="product-title">Total Amount</div>
                                            <div class="product-subtitle">{{ $transactions->price }}</div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                    ...
                                    <div class="col-12">
                                        <form action="{{ route('dashboard-transactions-update' ,$transactions->id) }}" method="POST">
                                            ...
                                            <div class="col-12 col-md-3">
                                                ...
                                                <select  id="status" class="form-control" v-model="status" name="shipping_status">
