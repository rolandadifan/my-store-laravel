...
<div class="section-content section-dashboard-home" data-aos="fade-up">
    <div class="container-fluid">
        <div class="dashboard-heading">
            ...
            <p class="dashboard-subtitle">Big Result Start The Small One</p>
        </div>
                ...
                <div class="col-12 mt-2">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            ...
                            <a href="{{ route('dashboard-transactions-detail', $item->id) }}" class="card card-list d-block">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-1">
                                            <img src="{{ Storage::url($item->product->galleries->first()->photos ?? '') }}" class="w-50" alt="">
                                        </div>
                                        <div class="col-md-4">
                                            {{ $item->product->name }}
                                        </div>
